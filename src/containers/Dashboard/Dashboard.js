...
import useWindowSize from '@hoa/lib/hooks/useWindowSize';
import appActions from '@hoa/redux/app/actions';
import ThemeSwitcher from '@hoa/containers/ThemeSwitcher/ThemeSwitcher';
import siteConfig from '@hoa/config/site.config';
